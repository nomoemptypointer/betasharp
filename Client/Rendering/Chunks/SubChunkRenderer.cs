...
using Shader = betareborn.Client.Rendering.Core.Shader;
using VertexArray = betareborn.Client.Rendering.Core.VertexArray;

namespace betareborn.Client.Rendering.Terrain
{
